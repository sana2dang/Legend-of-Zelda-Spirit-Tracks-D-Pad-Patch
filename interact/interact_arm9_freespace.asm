...
;Check A to check interactions
	...
	mov r2, r5
	mov r3, r6
	rbl 0x01FFD43C, 0x01FFD43C, 0x01FFD43C;write x,y positions to r1
	...
	asr r1, r1, 0x04
	rldr r2, 0x0203E93C, 0x0203E964, 0x0203FEB0;trig table
	...
	mov r0, r4
	mov r1, 0x02
	rbl 0x02014230, 0x02014230, 0x02014234;seems to be required for input
@@endroutine:
	add r13, r13, 0x10
	mov r0, r8
